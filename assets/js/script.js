...
document.getElementById("exportBtn").onclick = () => {
    ...
    canvas.getObjects().forEach((o) => {
      if (o.customProps) {
        const sec = o.customProps.section || "Unassigned";
        ...
        sections[sec].seats.push({
          row: o.customProps.row,
          col: o.customProps.col,
          seatName: o.customProps.seatName,
          type: o.customProps.type,
          price: o.customProps.price,
          floor: o.customProps.floor,
          left: o.left,
          top: o.top,
        });
      } else if (o.sectionLabel) {
        const sec = o.text || "Unnamed Section";
        if (!sections[sec]) {
          sections[sec] = {
            sectionName: sec,
            seats: [],
    ...
    // Convert sections object → array
    const exportData = Object.values(sections);
  
    console.log(JSON.stringify(exportData, null, 2));
    alert("Exported grouped JSON logged to console!");
  };
